...
VALUES ('11111111111', 'Funcionário A', 'Histórico X', 'produtor');

INSERT INTO Funcionarios (CPF, Nome, Hist_trabalhos, tipo)
VALUES ('22222222222', 'Funcionário B', 'Histórico Y', 'produtor');

INSERT INTO Funcionarios (CPF, Nome, Hist_trabalhos, tipo)
VALUES ('33333333333', 'Funcionário C', 'Histórico Y', 'editor');

INSERT INTO Funcionarios (CPF, Nome, Hist_trabalhos, tipo)
VALUES ('44444444444', 'Funcionário D', 'Histórico Y', 'editor');

INSERT INTO Funcionarios (CPF, Nome, Hist_trabalhos, tipo)
VALUES ('55555555555', 'Funcionário E', 'Histórico Y', 'dublador');

INSERT INTO Funcionarios (CPF, Nome, Hist_trabalhos, tipo)
VALUES ('66666666666', 'Funcionário F', 'Histórico Y', 'dublador');
...
VALUES ('55555555555', 'Estilo X', 'Português', 'Inglês', 'Espanhol');

INSERT INTO Dublador (CPF, Estilo_de_narracao, Idioma_Nativo, Idioma_Fluente, Idioma_Intermediario)
VALUES ('66666666666', 'Estilo Y', 'Inglês', 'Espanhol', 'Português');

-- Inserção na tabela Dubla
INSERT INTO Dubla (Dublador, Livro_Adaptado)
VALUES ('55555555555', '9781234567');

INSERT INTO Dubla (Dublador, Livro_Adaptado)
VALUES ('66666666666', '9780987654');

-- Inserção na tabela Editor
INSERT INTO Editor (CPF, Nivel_de_Experiencia)
VALUES ('33333333333', 'Experiente');

INSERT INTO Editor (CPF, Nivel_de_Experiencia)
VALUES ('44444444444', 'Iniciante');

-- Inserção na tabela Edita
INSERT INTO Edita (Editor, Livro_Adaptado)
VALUES ('33333333333', '9781234567');

INSERT INTO Edita (Editor, Livro_Adaptado)
VALUES ('44444444444', '9780987654');

-- Inserção na tabela Ferramentas_de_trabalho
INSERT INTO Ferramentas_de_trabalho (Editor, Ferramenta)
VALUES ('33333333333', 'Ferramenta X');

INSERT INTO Ferramentas_de_trabalho (Editor, Ferramenta)
VALUES ('44444444444', 'Ferramenta Y');

--Novas inserções
-- Inserção na tabela Livro
INSERT INTO Livro (ISBN, Titulo, Autor, Edicao, Editora, Produtor)
VALUES ('9781233567', 'Livro A', 'Autor A', 1, '12345678901234', NULL);

-- Inserção na tabela Livro_Adaptado
INSERT INTO Livro_Adaptado (ISBN, ISBN_Livro, Titulo, Idioma, Autor, Tamanho_Arquivo, Genero, Duracao, Classificacao, Descricao)
VALUES ('9781214567', '9781233567', 'Livro A', 'Português', 'Autor A', '10', 'Ficção', 120 , 10, 'Descrição A');


INSERT INTO Audiobook (ISBN, Titulo, Idioma, Autor, Duracao, Formato, Classificacao, Genero, Descricao, Livro_Adaptado)
VALUES ('9780887554', 'Livro A', 'Inglês', 'Autor A', 120 , 'MP3', 14, 'Ficção', 'Descrição A', '9781214567');

INSERT INTO Player (CNPJ, ISBN)
VALUES ('12345678901234', '9780887554');

INSERT INTO Acessa (Player_CNPJ, Player_ISBN, Leitor, n_livros_ouvidos)
VALUES ('12345678901234', '9780887554', '11111111111', 6);